...
$$
Nonlinear activations are therefore what make depth useful. They also control gradient flow, saturation, centering,
sparsity, and gating behavior.
...
Why it matters: zero-centered activations often lead to better-conditioned optimization because updates are less
