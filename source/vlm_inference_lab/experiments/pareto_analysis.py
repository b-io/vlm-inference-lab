...
def find_pareto_frontier(points: List[Dict[str, Any]], x_metric: str, y_metric: str, x_higher_is_better: bool = True, y_higher_is_better: bool = False):
    """
...
def process_results(input_dir: str, output_file: str = None):
    ...
    for p in frontier:
        ...
        md_output += f"| {p['throughput_rps']:.2f} | {p['latency_p95_ms']:.2f} | {p['throughput_tps']:.2f} | {p['concurrency']} | {config_str} |\n"
