...
class InferenceSimulator:
        ...
        while pending_requests or self.batcher.queue:
            ...
            if self.batcher.queue and (batch_full or timeout_reached or not pending_requests):
                ...
                with self.monitor.timer("gpu_inference"):
                    ...
                    prefill_time = (total_prefill_units * self.config.prefill_cost_per_unit) / self.config.gpu_throughput_per_unit
                    decode_time = (total_decode_tokens * self.config.decode_cost_per_token) / self.config.gpu_throughput_per_unit
    ...
    def _summarize(self) -> Dict[str, Any]:
        ...
        results = {
            ...
            "latency_avg_ms": statistics.mean(latencies_ms),
