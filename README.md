...
- **Features**: Automatic model ID resolution, **Proxied SSH support** (`ssh.runpod.io`), **SSH-only file creation
  fallback** (no SCP required), and **managed-instance safety guards**.
